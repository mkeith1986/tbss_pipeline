...
# One-way ANOVA, 1 factor, more than 2 levels
# Using the factor effects model and one F-test for the main effect of the factor, which combines individual tests for each of the EVs that were constructed for the factor effect
...
randomise -i all_FA_skeletonised.nii.gz -o anova -m mean_FA_skeleton_mask.nii.gz -d design.mat -t design.con -f design.fts -n 500 -D --T2
echo "DONE randomise"
